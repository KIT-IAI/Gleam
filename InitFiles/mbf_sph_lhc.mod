...
GLEAM/AE  MathFkt  MBF-Sphere   withLS                                25.01.2019
...
30                number of gene types
 1   0.000001     akt_roh_erg_werte des (Ext)Simu   small_change_frac (optional)
 0                number of additional files
BEGIN_LS
 2  0             number of active LHCs   number of active heuristics
0  1              List of indices of active LHCs
5000  0.00000001  LSV0 (Rosen): iteration limit  abort limit 
