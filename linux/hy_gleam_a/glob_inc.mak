...
#
# Global include file for HyGLEAM/A (hy_gleam_a) as command line version (CLV) or with 
...
#-----------------------------------------------------------------------------------------
BASIC_OBJ = $(SYS_OBJ) $(FBHM_OBJ) $(LGSW_OBJ) $(CHIO_OBJ) $(APPL_OBJ) $(HMOD_OBJ) $(ROCO_OBJ)

TUI_BASIC1_OBJ = $(CTIO_TUI)  $(BEW_TUI)  $(AUFG_TUI)  $(CHED_TUI) 
CLV_BASIC1_OBJ = $(CTIO_CLV)  $(BEW_CLV)  $(AUFG_CLV)             

TUI_BASIC2_OBJ = $(LSKP_TUI)  $(SIMU_TUI) $(EVO_LSVRC_TUI)  $(MEN_TUI) 
CLV_BASIC2_OBJ = $(LSKP_CLV)  $(SIMU_CLV) $(EVO_LSVRC_CLV)  $(MEN_CLV)
